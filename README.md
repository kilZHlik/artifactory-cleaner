...
<span style="font-style:italic; font-size:4em;"> Note: When building regexps and using backslashes, do not forget that in yaml format the ackslash must be escaped by the second backslash.</span>
